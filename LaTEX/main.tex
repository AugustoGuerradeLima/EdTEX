...
\begin{figure}
  \centering
  \includegraphics[width=0.2\linewidth]{UFMG.png}
\end{figure}
...
\begin{figure}
  \centering
  \includegraphics[width=0.4\linewidth]{O(f(n)).png}
    \caption{$g(n)=O(f(n))$.}
    \label{O(f(n))}
\end{figure}
...
\begin{figure}
  \centering
  \includegraphics[width=0.4\linewidth]{Omega.png}
...
\begin{figure}
  \centering
  \includegraphics[width=0.4\linewidth]{Theta.png}
...
\begin{figure}
  \centering
  \includegraphics[width=0.4\linewidth]{conjuntonotacoes.png}
...
\begin{figure}
  \centering
  \includegraphics[width=0.4\linewidth]{Classes.png}
